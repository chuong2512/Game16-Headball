...
public class CharacterController2D : MonoBehaviour
{
    ...
    [Range(0, 90f)] public float slopeLimit = 30f;

    public float jumpingThreshold = 0.07f;

    public AnimationCurve slopeSpeedMultiplier =
        new AnimationCurve(new Keyframe(-90, 1.5f), new Keyframe(0, 1), new Keyframe(90, 0));
    ...
    [Range(0.8f, 0.999f)] public float triggerHelperBoxColliderScale = 0.95f;
